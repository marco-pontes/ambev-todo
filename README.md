...
- In `package.json`, remove `simple-fake-api` from the `start` script, then restart the app. By default, `npm run start` launches simple-fake-api alongside Vite.


## Table of Contents
- [Quick start](#quick-start-most-common-commands)
- [Technologies / libraries](#technologies--libraries)
- [Special note about the API](#special-note-about-the-api)
- [Features](#features)
- [Project structure](#project-structure)
- [Scripts](#scripts)
- [API and data layer](#api-and-data-layer-marco-pontessimple-fake-api)
- [Enabling MirageJS (mock server)](#enabling-miragejs-mock-server)
- [Internationalization (i18n)](#internationalization-i18n)
- [Testing](#testing)
- [Development notes and configuration](#development-notes-and-configuration)
...
- UI/UX
  - Responsive layout built with Chakra UI components
  - Accessible controls with `aria-label`s (including action buttons in the table)
- Internationalization
  - Translations for `pt-BR`, `en` and `es`
  - Covers app-level strings and Todos feature strings
...
- The table and status labels resolve via keys like `todos.enums.status.PENDING` and `todos.enums.status.COMPLETED`; all locales share the same key structure for consistency.
